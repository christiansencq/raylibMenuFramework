...
if("${show_ref_output}" MATCHES "refs/remotes/develop")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "develop")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 develop
  WORKING_DIRECTORY "/home/charles/Cpp/StateStack/build/_deps/sol2-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/charles/Cpp/StateStack/build/_deps/sol2-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/charles/Cpp/StateStack/build/_deps/sol2-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
